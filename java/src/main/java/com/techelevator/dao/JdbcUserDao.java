...
public class JdbcUserDao implements UserDao {
    ...
    public List<User> getUsers() {
        ...
        String sql = "SELECT user_id, username, yourname, email, phone_number, password_hash, role FROM users";
        try {
    ...
    public User getUserByUsername(String username) {
        ...
        User user = null;
        String sql = "SELECT user_id, username, yourname, email, phone_number, password_hash, role FROM users WHERE username ILIKE ?;";
        try {
    ...
    public User createUser(RegisterUserDto user) {
        ...
        try {
            int newUserId = jdbcTemplate.queryForObject(insertUserSql, int.class, user.getUsername(),
                    user.getYourName(), user.getEmail(), user.getPhoneNumber(), password_hash, ssRole);
